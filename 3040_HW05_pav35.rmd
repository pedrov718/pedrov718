...
absenteeism
ggplot(data = absenteeism, mapping = aes(x = age, y = days, color = sex, shape = sex))+ geom_point() + geom_violin() + labs(title="Absenteeism",
        x ="Year in School", y = "Number of Days Absent")
...
count(age_at_mar["age"])


#ggplot(data = age_at_mar, mapping = aes(x = age, y = frequency(age_at_mar$age)))
...
ggplot(data = gather(lizard_habitat, sunlight, site), mapping = aes(x = site, y= sunlight, fill = sunlight)) + geom_bar() 
